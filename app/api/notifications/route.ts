...
export async function GET() {
  ...
  // DRAFT playbooks waiting for confirmation
  ...
  // Approvals that have been approved (decision = 'APPROVED')
  ...
  // Sort by type priority: warning > action > info > success, then by date
