...
export default function GlobalError({
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-lg rounded-xl border border-[rgba(0,191,166,0.2)] bg-[rgba(0,12,28,0.92)] p-6 backdrop-blur-md">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button type="button" onClick={reset} className="rounded-md bg-[#00BFA6] px-4 py-1.5 text-sm font-semibold text-[#050810] hover:bg-[#00A896]">
            다시 시도
          </button>
          <button type="button" onClick={onCopy} className="rounded-md border border-[rgba(0,191,166,0.3)] bg-transparent px-4 py-1.5 text-sm text-[#00BFA6] hover:bg-[rgba(0,191,166,0.08)]">
            복구 명령 복사
          </button>
        </div>
        ...
        <details className="mt-4 rounded-lg border border-[rgba(0,191,166,0.12)] bg-[rgba(0,20,40,0.6)] p-3">
